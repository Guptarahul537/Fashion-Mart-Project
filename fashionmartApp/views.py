...
from fashionmart.settings import RAZORPAY_API_KEY,RAZORPAY_API_SECRET_KEY
import razorpay
from .models import *
    ...
    if (Request.method == 'POST'):
        ...
        if (p == cp):
            ...
            if (user):
                ...
                user.save()
                b.save()
                subject = 'Your Account is Created : Team Fashion Mart'
                message = 'Hello '+b.name+'\nThanks for creating Buyer Account/nNow you can Buy Our Latest Product : Team Fashion Mart'
...
client = razorpay.Client(auto=(RAZORPAY_API_KEY,RAZORPAY_API_SECRET_KEY))
@login_required(login_url='/login/')
def orderPage(Request):
    if(Request.method == 'POST'):
        ...
        if(cart is None):
            ...
            subject = 'Your Order has been Placed : Team Fashion Mart'
            ...
            if(mode=='COD'):
                ...
                check.save()
                return render(Request,'pay.html',{'amount':orderAmount,'api_key':RAZORPAY_API_KEY,'order_id':paymentId,'User':user})
    else:
...
def contactPage(Request):
    if(Request.method=='POST'):
        ...
        c.save()
        messages.success(Request,"Thanks to Shere your Query with us!!! Our Team will Contact you Soon")
    ...
    if(Request.method=="POST"):
        ...
        try:
            ...
            if(user.is_superuser):
                ...
                buyer.otp = otp
                buyer.save()
                subject = 'OTP for Password Reset : Team Fashion Mart'
